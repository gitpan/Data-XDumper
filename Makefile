# This Makefile is for the Data::XDumper extension to perl.
#
...
#     ABSTRACT_FROM => q[XDumper.pm]
#     AUTHOR => q[Matthijs van Duin <xmath@cpan.org>]
#     NAME => q[Data::XDumper]
#     PREREQ_PM => { Attribute::Property=>q[0] }
#     VERSION_FROM => q[XDumper.pm]
...
AR_STATIC_ARGS = cr
NAME = Data::XDumper
DISTNAME = Data-XDumper
NAME_SYM = Data_XDumper
VERSION = 1.00
VERSION_SYM = 1_00
XS_VERSION = 1.00
...
TO_INST_PM = XDumper.pm

PM_TO_BLIB = XDumper.pm \
	blib/lib/Data/XDumper.pm
...
manifypods : pure_all XDumper.pm
	@$(POD2MAN) \
	XDumper.pm \
	$(INST_MAN3DIR)/Data::XDumper.$(MAN3EXT)
...
pm_to_blib: $(TO_INST_PM)
	...
	-e "pm_to_blib({qw{XDumper.pm blib/lib/Data/XDumper.pm}},'$(INST_LIB)/auto','$(PM_FILTER)')"
	@$(TOUCH) $@
